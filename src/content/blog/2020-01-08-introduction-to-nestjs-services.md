...
description: 'How we can work with services in NestJS'
author: Santosh Yadav
publishDate: 2020-01-08
preview: ../images/medium/introduction-to-nestjs-services.png
coverSVG: ../images/medium/introduction-to-nestjs-services.png
socialImage: ../images/medium/introduction-to-nestjs-services.png
canonicalUrl: https://medium.com/@santosh.yadav198613/introduction-to-nestjs-services-2a7c9a629da9
categories:
  - NestJS
tags:
  - NestJS
...
In enterprise applications, we follow the SOLID principle, where S stands for _Single Responsibility_.
...
There are two types of services that can be created in [NestJS](https://nestjs.com/):
...
Nest lets us create the factory, create a new file `connection.provider.ts`, and add the below code.
...
We learned about how to create and use different types of providers in NestJS, we used the dependency injection design pattern to use services, which lets you achieve Singel Responsibility as well.
