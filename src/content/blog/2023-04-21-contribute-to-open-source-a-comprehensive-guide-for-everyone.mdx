...
publishDate: 2026-02-16T21:08:51.788Z
preview: ../images/oss/oss-banner-og.png
coverSVG: ../images/oss/oss-banner-og.png
socialImage: ../images/oss/oss-banner-og.png
...
## Contributing as designer

Contribution as designed is Underrated, not many OSS maintainer are not good a design, and they need help too.

I spoke to my friend [Eriol Fox](https://erioldoesdesign.github.io/)  

### How Eriol started contributing to Open Source as a designer?

I found out about OSS long before I started contributing. As a designer, was not
taught in design education (or in my professional development) what OSS was and
what it means for the foundations of the open web. I learned about OSS when i asked
a CTO I worked with at a tech startup when we were reviewing resume’s for
developers what the OSS contribution sections were and what they mean’t. The CTO
then helpfully, along with some other developers in a previous position I was in all
about why developers might contribute to OSS, how they learn about it, why it’s
valuable as a career growth move and also how useful OSS libraries are and other OSS
is when building tech so that best practice can be shared and work can go faster/
smoother by using and supporting common and useful OSS.
So I knew about OSS about 3 years before I then got hired as a designer at https://www.ushahidi.com/ . This humanitarian OSS technology was when I really gained my
deeper understanding of how meaningful and foundational OSS is across the globe.
So contributing to this OSS was then an essential part of my job role. From this role
and being involved in Mozilla [Open Leaders program](https://www.mozillafoundation.org/en/initiatives/mozilla-open-leaders) became involved in
https://opensourcedesign.net/ and also how designers could contribute to Ushahidi’s
OSS and also how we could improve design, usability and designers involvement in
OSS as a whole. After that I started making volunteer contributions to many OSS
projects, mentored early career designers through contribution to OSS and developed
as many OSS and design related resources as I was able to and still do this top this
day!

### How designers can contribute to open source

There are so many ways designers can contribute to OSS but I would say the most
accessible and useful way is by being interested in OSS, learning about what OSS is
and how it underpins the open web and a huge amount of software and hardware
globally. Going to OSS events and conferences, asking questions about usability, UI,
UX and design where OSS project maintainers and coders talk and having resilience
and patience to help the wider OSS world learn about why usability and design is
mutually beneficial for OSS and designers. Having designers involved in projects can
often mean that more and diﬀerent kinds of users can be considered in how the OSS
is built and designed. OSS’s big challenge now is becoming a viable and joyful
alternative to proprietary software for everyone, not just the folks that can solve
technical issues and problems to run OSS and not just for those of us running specific
open source set-ups. OSS should be usable for everyone should they want to use it
and I think designers are one of the crucial participants in making sure OSS can be
used and built by all kinds of people and users.
On a more practical point, looking on source forges and places where OSS repositories
live are ‘good places to start, search on github or gitlab for project keywords that
you're interested in and go from there. Explore an OSS projects docs, talk to people
that use and build OSS and see how you might help them solve design problems they
have and if you're having trouble still, you can always check out [Open Source Design Jobs](https://opensourcedesign.net/jobs/) and [Open Design Guide](https://opendesign.guide).
