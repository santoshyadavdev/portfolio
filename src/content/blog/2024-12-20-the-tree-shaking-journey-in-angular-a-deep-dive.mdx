...
description: "This year, I tried a new Angular version and wanted to experiment with how the tree shaking works once the standalone components came."
date: 2024-12-23T14:20:29.568Z
preview: ../images/bundle/tree-shaking-banner.png
coverSVG: ../images/bundle/tree-shaking-banner.png
socialImage: ../images/bundle/tree-shaking-banner.png
draft: false
publishDate: 2024-12-23T14:20:29.568Z
categories:
  - Angular
tags:
  - Angular
...
import helloworld from '../../images/bundle/tree-shaking-libs.png';
import individualmodule from '../../images/bundle/tree-shaking-modules.png';
import standalone from '../../images/bundle/tree-shaking-standalone.png'
import publishable from '../../images/bundle/tree-shaking-publish.png';
import buildwarning from '../../images/bundle/build-warnign.png';
...
<BlogImage src={helloworld} alt="main bundle shows 395 Bytes of code from the GodModuleLibModule" />
...
Angular is becoming smart at identifying dead code and eliminating tree shaking. If you have code with GodModule exporting multiple components, your app will still benefit from tree shaking. 
...
<BlogImage src={individualmodule} alt="The main bundle size is almost double; it's 701 Bytes now" />
...
We are all set to rerun the build and report, and wow, we have only 244 Bytes, and it includes only Button Code.
...
<BlogImage src={standalone} alt="The main bunlde contains only button code which is 244 Bytes" />
...
<BlogImage src={publishable} alt="main bundle shows 395 Bytes of code from the GodModuleLibModule" />
...
If you want to learn how to configure secondary-entrypoints, I recommedn watching this small course I did you YouTube

<YouTube id="FH3i0yKOi8U" />

Why should we still read this section and go with secondary entry points even though we have only been able to get the minimal code in the production bundle with standalone components in the exercise so far? 
...
1. For libraries with a lot of components, 
  1. I recommend splitting them into smaller libs.
  1. If it is publishable, I recommend going with secondary-entrypoint.
