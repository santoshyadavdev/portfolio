...
<BlogImage src={standalone} alt="The main bunlde contains only button code which is 234 Bytes" />
...
If you want to learn how to configure secondary-entrypoints, I recommend watching this small course I did you YouTube
