...
slug: how-ai-is-changing-my-development-workflow-and-i-am-excited-about-it
...
date: 2026-02-09T00:07:31.869Z
preview: ../images/2026/ai-cover-image.png
coverSVG: ../images/2026/ai-cover-image.png
socialImage: ../images/2026/ai-cover-image-og.png
draft: false
tags: ["AI","AI Development","Developer Experience","Workflow","Claude Code","CodeRabbit","GitHub Copilot","Anthropic"]
categories: ["career","development","AI","CodeRabbit"]
canonicalUrl: "https://santoshyadav.dev/blog/how-ai-is-changing-my-development-workflow-and-i-am-excited-about-it/"
publishDate: 2026-02-09T00:07:31.869Z
keywords:
    - AI Development
...
<BlogImage src={newWorkflow} alt={`A hand-drawn flowchart on a beige background. A box labeled "New Task" has an arrow pointing to a box labeled "Create a design doc and get it reviewed". From there, an arrow points to a box labeled "Give it to planning AI agent like GitHub copilot". An arrow from this box points to a box labeled "Read docs, blogs, see videos, search on internet, stackoverflow etc". An arrow from this box points to a box labeled "Write code". An arrow from "Write code" points to a diamond-shaped decision box labeled "getting issues?". If the answer is "No", an arrow points to a final box labeled "Raise a PR/MR". If the answer is "Yes", an arrow loops back up to the box labeled "Give it to planning AI agent like GitHub copilot".`} />
...
Senior Developers are Vibe Coding Now (With SCARY results) From TraversyMedia
