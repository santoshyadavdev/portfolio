...
const YOUTUBE_UPLOADS_PLAYLIST_ID = "UUhvYTafHRgXKb0VbYGeG0nw";
...
export function getChannelVideos(limit?: number) {
  return getPlaylistVideos(YOUTUBE_UPLOADS_PLAYLIST_ID, limit);
}
